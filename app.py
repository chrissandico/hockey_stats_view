...
st.set_page_config(
    ...
    page_icon="🏒",
    layout="wide",
    initial_sidebar_state="expanded"  # Always expanded to ensure consistency across devices
)
...
def check_password():
    ...
    if not st.session_state["authenticated"]:
        # Show login form with enhanced styling using CSS classes instead of inline styles
        ...
        <div class="login-container">
            <div class="login-header">
                ...
                <h1 class="custom-heading">Hockey Stats Dashboard</h1>
...
st.markdown("""
    <h1 class="custom-heading">🏒 Hockey Statistics Dashboard</h1>
    <div class="android-heading-fallback">🏒 Hockey Statistics Dashboard</div>
""", unsafe_allow_html=True)
